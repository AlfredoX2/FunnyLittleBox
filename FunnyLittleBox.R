...
movie3d(
  ...
  spin3d( axis = c(0, 0, 1), rpm = 15,dev = cur3d()),
  startTime = 3,
  duration = 7, 
  dir = "images",
  type = "gif",
...
my_gif <- image_read("images/3dAnimatedScatterplot.gif") 

infinite_loop_gif <- image_animate(
  my_gif,
  fps = 20
  )
image_write(infinite_loop_gif, path = "images/infinite_loop4.gif")
